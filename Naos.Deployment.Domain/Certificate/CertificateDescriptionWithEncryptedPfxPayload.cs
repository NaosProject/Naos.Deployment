...
namespace Naos.Deployment.Domain
{
    ...
    public class CertificateDescriptionWithEncryptedPfxPayload : CertificateDescription
    {
        ...
        public CertificateDescriptionWithEncryptedPfxPayload(string friendlyName, DateTimeRange validityWindowInUtc, Dictionary<string, string> certificateAttributes, CertificateLocator encryptingCertificateLocator, string encryptedFileBase64, string encryptedPfxPassword, string certificateSigningRequestPemEncoded = null)
        ...
        public CertificateDescriptionWithClearPfxPayload ToDecryptedVersion()
        {
            ...
            var ret = new CertificateDescriptionWithClearPfxPayload(this.FriendlyName, this.ValidityWindowInUtc, this.CertificateAttributes, certificateBytes, decryptedPassword, this.CertificateSigningRequestPemEncoded);
