// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MinimalJsonSerializer.cs">
...
#endif
    internal static partial class MinimalJsonSerializer
    {
        /// <summary>
        ...
        {
            var result = JsonConvert.DeserializeObject<T>(value, JsonConfiguration.MinimalSerializerSettings);
            return result;
        }
        ...
        {
            var result = JsonConvert.DeserializeObject(value, JsonConfiguration.MinimalSerializerSettings);
            return result;
        }
        ...
        {
            var result = JsonConvert.DeserializeObject(value, type, JsonConfiguration.MinimalSerializerSettings);
            return result;
        }
