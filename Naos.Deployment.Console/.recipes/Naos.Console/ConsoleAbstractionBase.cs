...
namespace Naos.Deployment.Console
{
    ...
    public abstract class ConsoleAbstractionBase
    {
            ...
            [Aliases("")] [Description("Sets the Its.Configuration precedence to use specific settings.")] [DefaultValue(null)] string environment)
        {
             ...
             *---------------------------------------------------------------------------*/
            Naos.Logging.Domain.Log.Write(() => message);
        }
...
#pragma warning restore CS3001 // Argument type is not CLS-compliant
        {
            ...
            else
            {
                ...
                Naos.Logging.Domain.Log.Write(() => context.Exception);
            }
        ...
        protected static void CommonSetup(bool debug, string environment = null, LogWritingSettings logWritingSettings = null, IReadOnlyCollection<LogWriterBase> configuredAndManagedLogProcessors = null, Action<string> announcer = null)
        {
            ...
            {
                Config.Precedence = new[] { environment };
            }
            ...
            Naos.Logging.Persistence.LogWriting.Instance.Setup(localLogProcessorSettings, localAnnouncer, configuredAndManagedLogProcessors);
        ...
        protected static void WriteStandardTelemetry()
        {
            ...
            Naos.Logging.Domain.Log.Write(() => diagnosticsTelemetry);
        }
    ...
    public class ExampleConsoleAbstraction : ConsoleAbstractionBase
    {
            ...
            [Required] [Aliases("")] [Description("Example of a directory that needs to be checked for files to process.")] string filePathToProcess)
        {
            ...
            Naos.Logging.Domain.Log.Write(() => Invariant($"Processed files at: {filePathToProcess}"));
        }
    }
}