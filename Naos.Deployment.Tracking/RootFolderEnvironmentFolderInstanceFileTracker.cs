...
namespace Naos.Deployment.Tracking
{
    ...
    public class RootFolderEnvironmentFolderInstanceFileTracker : ITrackComputingInfrastructure
    {
        ...
        private static readonly ISerializeAndDeserialize Serializer = new ObcJsonSerializer(typeof(NaosDeploymentTrackingJsonSerializationConfiguration).ToJsonSerializationConfigurationType());
