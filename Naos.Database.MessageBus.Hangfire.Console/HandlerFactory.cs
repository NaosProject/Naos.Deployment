...
namespace Naos.Database.MessageBus.Hangfire.Console
{
    ...
    public static partial class HandlerFactory
    {
        ...
        /// </summary>
        private static readonly IReadOnlyDictionary<Type, Type> MessageTypeToHandlerTypeMap = DiscoverHandlersInAssemblies(new[] { typeof(BackupSqlServerDatabaseMessage).Assembly, typeof(BackupSqlServerDatabaseMessageHandler).Assembly });
    }
}