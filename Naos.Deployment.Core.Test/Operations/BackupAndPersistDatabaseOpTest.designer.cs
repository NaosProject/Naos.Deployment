...
namespace Naos.Deployment.Core.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<BackupAndPersistDatabaseOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<BackupAndPersistDatabaseOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<BackupAndPersistDatabaseOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BackupAndPersistDatabaseOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<BackupAndPersistDatabaseOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Deployment.Domain.BackupAndPersistDatabaseOp: DatabaseName = {systemUnderTest.DatabaseName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Timeout = {systemUnderTest.Timeout.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<BackupAndPersistDatabaseOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<BackupAndPersistDatabaseOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<BackupAndPersistDatabaseOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'databaseName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<BackupAndPersistDatabaseOp>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<BackupAndPersistDatabaseOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<BackupAndPersistDatabaseOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BackupAndPersistDatabaseOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<BackupAndPersistDatabaseOp>
                        {
                            SystemUnderTest = new BackupAndPersistDatabaseOp(
        ...
        private static readonly DeepCloneWithTestScenarios<BackupAndPersistDatabaseOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<BackupAndPersistDatabaseOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupAndPersistDatabaseOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BackupAndPersistDatabaseOp>().ThatIs(_ => !systemUnderTest.DatabaseName.IsEqualTo(_.DatabaseName));

                        var result = new SystemUnderTestDeepCloneWithValue<BackupAndPersistDatabaseOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BackupAndPersistDatabaseOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BackupAndPersistDatabaseOp>().ThatIs(_ => !systemUnderTest.Timeout.IsEqualTo(_.Timeout));
        ...
        private static readonly BackupAndPersistDatabaseOp ReferenceObjectForEquatableTestScenarios = A.Dummy<BackupAndPersistDatabaseOp>();

        private static readonly EquatableTestScenarios<BackupAndPersistDatabaseOp> EquatableTestScenarios = new EquatableTestScenarios<BackupAndPersistDatabaseOp>()
            .AddScenario(() =>
                new EquatableTestScenario<BackupAndPersistDatabaseOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new BackupAndPersistDatabaseOp[]
                    {
                        new BackupAndPersistDatabaseOp(
                                ReferenceObjectForEquatableTestScenarios.DatabaseName,
                                ReferenceObjectForEquatableTestScenarios.Timeout),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new BackupAndPersistDatabaseOp[]
                    {
                        new BackupAndPersistDatabaseOp(
                                A.Dummy<BackupAndPersistDatabaseOp>().Whose(_ => !_.DatabaseName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.DatabaseName)).DatabaseName,
                                ReferenceObjectForEquatableTestScenarios.Timeout),
                        new BackupAndPersistDatabaseOp(
                                ReferenceObjectForEquatableTestScenarios.DatabaseName,
                                A.Dummy<BackupAndPersistDatabaseOp>().Whose(_ => !_.Timeout.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Timeout)).Timeout),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<DownloadAndRestoreDatabaseOp>(),
                    },
                });
        ...
        public static class Structural
        {
            ...
            public static void BackupAndPersistDatabaseOp___Should_implement_IModel_of_BackupAndPersistDatabaseOp___When_reflecting()
            {
                // Arrange
                var type = typeof(BackupAndPersistDatabaseOp);

                var expectedModelMethods = typeof(IModel<BackupAndPersistDatabaseOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<BackupAndPersistDatabaseOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void BackupAndPersistDatabaseOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(BackupAndPersistDatabaseOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (BackupAndPersistDatabaseOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "DatabaseName", "Timeout" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (BackupAndPersistDatabaseOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(BackupAndPersistDatabaseOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<BackupAndPersistDatabaseOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                BackupAndPersistDatabaseOp systemUnderTest1 = null;
                BackupAndPersistDatabaseOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    BackupAndPersistDatabaseOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupAndPersistDatabaseOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupAndPersistDatabaseOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupAndPersistDatabaseOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupAndPersistDatabaseOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BackupAndPersistDatabaseOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
